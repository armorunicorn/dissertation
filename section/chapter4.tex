...
词向量在文本特征表达上更加有效，同时传统LSTM网络的结果优于传统CNN网络，
显示出使用LSTM结构的循环神经网络比卷积神经网络更加适合
提取文本特征。对于表格的第3行与第4行，证明了结合CNN与RNN的卷积循环神经网络能够有效提升模型对文本数据的表达能力，
而加入Attention Model则能够进一步优化分类效果。
最后，对比其余模型，本文设计的双通道Attention-Based CLSTM分类模型取得了最好的结果，表明了
字向量文本特征能够很好的强化原本的词向量文本特征，让模型能够进一步的挖掘短文本的语义，
有效提高短文本分类的准确率。
\section{本章小结}
